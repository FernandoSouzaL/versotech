...
// GALERIA COM THUMBNAILS
 /* add_filter('post_gallery', 'my_post_gallery', 10, 2);
  ...
  function script_filter() {
    ...
    wp_register_script( 'scripts', get_stylesheet_directory_uri() . '/public/js/main-ajax.js', array('jquery') );
  ...
  function loadmore_ajax_handler() {
    ...
    if( have_posts() ):
      ...
      while( have_posts() ): the_post();
        ...
        get_template_part( 'partials/example-ajax' );
  ...
  function nav_menu_li_class( $classes, $item, $args ) {
